...
import '../../core/Reusable Widgets/custom_scaffold.dart';

class PlayerAssisters extends StatelessWidget {
  const PlayerAssisters({super.key});
    ...
    return CustomScaffold(
      ...
      body: Consumer<PlayersStatusProvider>(
        builder: (context, playerStatusProvider, child) {
          ...
          if (playerStatusProvider.assisters.isEmpty) {
            return FadeIn(
              child: Center(
                child: Column(
          ...
          return ListView.builder(
            ...
            itemCount: playerStatusProvider.assisters.length,
            itemBuilder: (context, index) {
              final player = playerStatusProvider.assisters[index];
